...
sim_time =  0.0:0.1:10; % For howlong the simulation will run
...
sgtitle('Visual Represntation of the effect of different \omega_n and \zeta values on the Response of a system');
